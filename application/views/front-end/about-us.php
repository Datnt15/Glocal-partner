...
<div class="main main-raised">
	<div class="container">
				...
				<div class="col-md-3">
					<div class="card card-profile card-plain">
						...
						<div class="card-content">
							...
							<div class="footer">
								<a href="about-us.html#pablo" class="btn btn-just-icon btn-simple btn-twitter"><i class="fa fa-twitter"></i></a>
								<a href="about-us.html#pablo" class="btn btn-just-icon btn-simple btn-facebook"><i class="fa fa-facebook-square"></i></a>
								<a href="about-us.html#pablo" class="btn btn-just-icon btn-simple btn-google"><i class="fa fa-google"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="card card-profile card-plain">
						...
						<div class="card-content">
							...
							<div class="footer">
								<a href="about-us.html#pablo" class="btn btn-just-icon btn-simple btn-twitter"><i class="fa fa-twitter"></i></a>
								<a href="about-us.html#pablo" class="btn btn-just-icon btn-simple btn-dribbble"><i class="fa fa-dribbble"></i></a>
								<a href="about-us.html#pablo" class="btn btn-just-icon btn-simple btn-linkedin"><i class="fa fa-linkedin"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
		           	<div class="info info-horizontal">
						...
						<div class="description">
							...
							<a href="about-us.html#pablo">Find more...</a>
						</div>
		        	</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker" data-style="btn btn-info btn-round" title="Single Select" data-size="5">
        ...
        <div class="contact-content">
            ...
            <p class="description text-center">You can contact us with anything related to our Products. We'll get in touch with you as soon as possible.<br><br>
            </p>
            <div class="row">
                <div class="col-md-6">
